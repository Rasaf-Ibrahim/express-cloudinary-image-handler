...
| allowedExtensions    | array   | Required    | List of allowed file extensions for the image.                                                        |
| maxFileSizeInKB      | number  | Required    | Maximum allowed file size for the image in kilobytes.                                                 |
